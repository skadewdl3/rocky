...
#slide[
  ...
  In a compiler, an expression is typically a tree structure (AST) that we traverse to emit a sequence of instructions. Each expression returns a value (an LLVM virtual register).
